##### check required packages are installed. if not installed install them
# list_of_packages <- c("ggplot2", "ggplot2movies", "qqman", "ggforestplot", "cowplot", "ggrepel", "dplyr", "wesanderson")
...
# Genome wide data {#gwas_data}
gwas_data <- gwasResults

## Correlation matrix {#matrix_corr}
